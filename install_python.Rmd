...
Faut installer Python et le configurer, pas besoin d'un environnement virtuel comme il ne s'agit pas d'une installation persistante.
...
if(py_module_available("pyarrow")) {print("Pyarrow is available.")}
   else {print("Warning, Pyarrow is not available.")}
```
