...
Pour utiliser cet environnement, il est nécessaire de réinitialiser reticulate. Le code suivant le désinstalle puis le réinstalle. Il génère une invite à redémarrer R : on peut s'en dispenser, sinon il faut exécuter à nouveau le notebook dependencies.Rmd
