...
plot <- ggplot(graph_data, aes(x = year)) +
  ...
  labs(title = "Evolution des paramètres d'intérêt",
       subtitle = "1965-2022",
       x = "Année",
       y = "Pourcentage",
       color = "Outcomes") +
...
plot <- ggplot(propri_df, aes(x = year)) +
  ...
  labs(title = "Taux de propriétaires de leur résidence principale",
       subtitle = "1960-2022",
       x = "Année",
       y = "",
       color = "") +
...
```{r}
plot <- ggplot(panel_data, aes(x = ppropri, y = as.factor(year), fill = ..x..)) +
...
plot <- ggplot(coefficients) +
  ...
  scale_fill_manual(
    ...
    labels = c("part" = "Participation", "GD_ratio" = "GD Ratio", "EC_ratio" = "EC Ratio")) +
  scale_x_continuous(breaks = unique(coefficients$year)) +
  labs(title = "Coefficients de ppropri dans les panels", subtitle = "(avec interactions temporelles et tours confondus)",
       x = "Année",
       y = "",
       color = "Coefficient",
       fill = "95 % IC") +
...
plot <- ggplot(results) +
  ...
  scale_fill_manual(
    values = c("part_T1" = "skyblue", "GD_ratio_T1" = "orange", "EC_ratio_T1" = "lightgreen"),
    labels = c("part_T1" = "Participation", "GD_ratio_T1" = "GD Ratio", "EC_ratio_T1" = "EC Ratio")) +
  labs(title = "Coefficients de ppropri dans les régressions annuelles",
       x = "Année",
       y = "",
       color = "Coefficient",
       fill = "95 % IC") +
...
pseudo_quant_reg <- function(outcome) {
  ...
  plot_r2 <- ggplot(R2_df, aes(x = year, y = R2, color = quantile, group = quantile)) +
    ...
    labs(title = paste("R2 des régressions pseudo-quantiles de", outcome), subtitle ="(quartiles mobiles)",
         x = "Année",
         y = "R2",
         color = "Quartiles") +
    theme_grey() +
  ...
  plot_coef <- ggplot(coefs_df, aes(x = year, y = coefficient, color = quantile, group = quantile)) +
    ...
    labs(title = paste("Coefficients de ppropri dans les régressions pseudo-quantiles de", outcome), subtitle ="(quartiles mobiles)",
         x = "Année",
         y = "Coefficient",
         color = "Quartiles") +
    theme_grey() +
...
plot_counts <- ggplot(ppropri_df, aes(x = year, y = sum_comm)) +
  ...
  labs(title = "Nombre de communes où le taux de propriétaires est >95%",
       x = "Année",
       y = "Effectifs") +
  theme_grey() +
  theme(
