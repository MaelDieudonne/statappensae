...
plot_coeffs <- function(subset_var) {
  subset_data <- subset(coefficients, outcome == subset_var)
  ggplot(subset_data) +
    ...
    scale_fill_manual(values = c("IC" = "grey")) +
    labs(title = paste("Coefficients de ppropri dans les panels -", subset_var), subtitle = "(avec interactions temporelles)",
...
plot_coeffs("part_T1")
plot_coeffs("GD_ratio_T1")
plot_coeffs("EC_ratio_T1")
...
plot_coeffs <- function(subset_var) {
  ...
  ggplot(subset_data) +
    ...
    scale_color_manual(values = c("coef" = "cornflowerblue")) +
    scale_fill_manual(values = c("IC" = "grey")) +
    labs(title = paste("Coefficients de ppropri dans les panels -", subset_var), subtitle = "(avec interactions temporelles et tours confondus)",
         x = "Année", y = "Coefficient") +
    theme_minimal() +
    theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5), legend.position = "none")
}
...
plot_coeffs("part")
plot_coeffs("GD_ratio")
plot_coeffs("EC_ratio")
