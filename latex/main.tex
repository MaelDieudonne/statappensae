...
\textsc{\LARGE ENSAE}\\[0.5cm] % Name of your university/college
...
\textsc{\Large Projet de statistiques appliquées}\\[0.5cm] % Major heading such as course name
...
\HRule \\[0.4cm]
{ \huge \bfseries Propriété immobilière et comportements électoraux}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
