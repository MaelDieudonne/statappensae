...
stat_desc_tbl <- stat_desc %>%
  ...
  cols_label(Variable = "") %>%
  tab_row_group(label = "Outcomes", rows = 1:5, id = "out") %>%
  tab_row_group(label = "Régresseurs", rows = 6:31, id = "reg") %>%
  row_group_order(groups = c("out", "reg")) %>%
  tab_style(
    style = list(
      cell_fill(color = "lightgrey"),
      cell_text(style = "italic", align = "center", v_align = "top")),
...
stat_desc_tbl
gtsave(stat_desc_tbl, filename = "stat_desc_acp.tex", path = "output_panel")

rm(col, nb_communes, stat_desc, stat_desc_tbl, summary)
```
...
ggcorrplot(t(result$var$contrib[, 1:10]),
           method = "circle",
           ggtheme = theme_grey,
           title = "Contribution des variables à l'inertie des axes",
           show.legend = TRUE,
           legend.title = "",
...
ggcorrplot(t(result$var$coord[, 1:3]),
           method = "square",
           ggtheme = theme_grey,
           title = "Corrélation des outcomes aux axes",
           show.legend = TRUE,
           legend.title = "",
           colors = c("#6D9EC1", "white", "#E46726"),
           outline.color = "darkgrey",
...
ggcorrplot(t(result$quanti.sup$coord[, 1:3]),
           method = "square",
           ggtheme = theme_grey,
           title = "Corrélation des régresseurs aux axes",
           show.legend = TRUE,
           legend.title = "",
           colors = c("#6D9EC1", "white", "#E46726"),
           outline.color = "darkgrey",
...
ggcorrplot(t(result$var$cos2[, 1:3]),
           method = "square",
           ggtheme = theme_grey,
           title = "Qualité de représentation des variables électorales",
           show.legend = TRUE,
           legend.title = "",
           colors = c("#6D9EC1", "white", "#E46726"),
           outline.color = "darkgrey",
...
plot2$labels$title <- "Qualité de représentation"
plot2$labels$subtitle <- "des régresseurs"

plot2$theme$plot.title$hjust <- 0.5
plot2$theme$plot.title$size <- 12
plot2$theme$plot.subtitle$hjust <- 0.5
plot2$theme$plot.subtitle$size <- 12
plot2$theme$legend.key.width <- unit(0.3, 'cm')
plot2$theme$legend.key.height <- unit(1.8, 'cm')
...
Les résultats invitent à choisir k = 6 ou 7. On commence par 6.
...
means_tbl <- t_means %>%
 ...
 tab_style(
    ...
    locations = list(
      cells_column_labels(columns = c("1", "2", "3", "4", "5", "6")),
...
draw_map_cluster <- function(region, base_width) {
  ...
  output_file <- paste0("output_transversal/clusters_2017_k6_", reg_abrv, ".png")
  title <- paste0("Clusters en ", reg_name)
  legend_labels <- c("2" = "Centre des grandes villes",
                     "3" = "Banlieues et zones périurbaines aisées",
                     "4" = "Banlieues et villes pauvres",
                     "5" = "Rural à dominante paysanne",
                     "6" = "Rural précaire",
                     "1" = "Périurbain populaire")
  legend_colors <- c("2" = "blue",
                     "3" = "skyblue",
                     "4" = "aquamarine",
                     "5" = "darkgreen",
                     "6" = "limegreen",
...
## Classification avec k=7

On essaye maintenant avec 7 clusters.
...
means_tbl <- t_means %>%
 ...
 tab_style(
    style = list(
      cell_text(align = "center")),
    locations = list(
      cells_column_labels(columns = c("1", "2", "3", "4", "5", "6", "7")),
      locations = cells_body(columns = !matches("cluster"))))
means_tbl
