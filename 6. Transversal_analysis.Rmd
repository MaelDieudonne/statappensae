...
corrplot(correlation_matrix, type = "upper", method = "color", order = "FPC", tl.srt = 60, tl.col = "darkgrey")
...
corrplot(result$quanti.sup$cos2[, 1:3], title = "Qualité de représentation des régresseurs", is.corr = FALSE, mar = c(1, 1, 1.5, 1), tl.col = "darkgrey", tl.srt = 45, cl.align.text = "l", cl.cex = 0.7, cl.ratio = 0.3)
