...
outcomes <- c("part_T1", "GD_ratio_T1", "EC_ratio_T1", "part_T2", "EC_ratio_T2","DIns_ratio_T1", "GIns_ratio_T1", "EIns_ratio_T1", "CIns_ratio_T1", "CIns_ratio_T2", "EIns_ratio_T2")

stat_desc <- data.table()
for (col in c(outcomes, full_mca_regressors)) {
  summary <- mca_data[, {
...
stat_desc_tbl <- stat_desc %>%
  ...
  cols_label(Variable = "") %>%
  tab_row_group(label = "Outcomes", rows = 1:11, id = "out") %>%
  tab_row_group(label = "Régresseurs", rows = 12:37, id = "reg") %>%
