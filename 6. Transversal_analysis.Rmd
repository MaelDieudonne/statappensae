...
draw_map <- function(region, mapped_var, mapped_var_name, base_width) {
  ...
  plot_png <- ggplot() +
    ...
    scale_fill_viridis_c(name = mapped_var_name, labels = scales::percent_format(scale = 1), limits = c(lbound, 100)) +
    ggtitle(paste(title)) +
    theme_minimal() +
...
for (i in c(11, 24, 27, 28, 32, 44, 52, 53, 75, 76, 84, 93)) {draw_map(i, "ppropri", "Taux de propriétaires", 8)}
