...
means_tbl <- gt(means)
means_tbl <- fmt_number(means_tbl, decimals = 1, drop_trailing_zeros = TRUE)
means_tbl <- tab_header(means_tbl, "Moyenne des variables par cluster", subtitle = NULL, preheader = NULL)
data_color(means_tbl, method = "numeric", direction = "column", palette ="YlGnBu", )


## Faudrait encore...
# Transposer le tableau
# Insérer une ligne correspondant à la moyenne dans l'échantillon
