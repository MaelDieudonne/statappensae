...
print(xtable(stat_desc, type = "latex"), file = "output_transversal/stat_desc_acp.tex")
print(stat_desc)
...
regressors <- setdiff(regressors, c("popagglo", "type"))
mca_data_subset <- detailed_mca_data[, ..regressors]
mca_data_subset <- na.omit(mca_data_subset)
...
```{r}
# Tentative avec outcomes relatifs et régresseurs
set.seed(123)
