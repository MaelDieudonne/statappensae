...
na_table <- function(variable_names, file_name) {
  ...
  na_prop_table <- data_color(na_prop_table, method = "bin", bins = bins, columns = !starts_with("Année"), direction = "row", palette ="Oranges", na_color = "lightgrey")
  print(na_prop_table)
...
print(plot)
ggsave("output/outcomes_relatifs_1965_2022.png", plot, width = 8, height = 6, dpi = 300)
