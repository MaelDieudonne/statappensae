...
ggplot(R2_df, aes(x = factor(year), y = R2, color = quantile, group = quantile)) +
  geom_line() + +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgrey") + 
  labs(title = "R2 des régressions pseudo-quantiles", subtitle ="(quantiles variables)",
       x = "Année",
       y = "R2") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5))
...
ggplot(coefs_df, aes(x = factor(year), y = coefficient, color = quantile, group = quantile)) +
  geom_line() + +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgrey") + 
  labs(title = "Coefficients de ppropri dans les régressions pseudo-quantiles", subtitle ="(quantiles variables)",
       x = "Année",
       y = "Coefficient") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5))
...
ggplot(R2_df, aes(x = factor(year), y = R2, color = quantile, group = quantile)) +
  geom_line() +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgrey") + 
  labs(title = "R2 des régressions pseudo-quantiles", subtitle ="(quantiles absolus)",
       x = "Année",
       y = "R2") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5))
...
ggplot(coefs_df, aes(x = factor(year), y = coefficient, color = quantile, group = quantile)) +
  geom_line() +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgrey") + 
  labs(title = "Coefficients de ppropri dans les régressions pseudo-quantiles", subtitle ="(quantiles absolus)",
       x = "Année",
       y = "Coefficient") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5))
...
ggplot(coefs_df, aes(x = year, y = coefficient, color = factor(quantile))) +
  ...
  geom_point() +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgrey") + 
  labs(title = "Coefficients de ppropri dans les régressions quantiles sur part_T1",
