...
```{python}
# Conversion au format Parquet, avec correction de l'encodage, sans compression
...
```{python}
# Optionnel : téléversement sur le Datalab
...
for variable in ['csv_files', 'data', 'dirs', 'detect_encoding_short', 'detect_encoding_long', 'encoding_short', 'encoding_long', 'file', 'filename', 'filenames', 'filepath', 'files', 'foldername', 'input_csv_path', 'output_parquet_path', 'progress_bar', 'relative_path', 'root', 'subfolders', 'table', 'total_csv_files', 'total_size', 'total_size_mb', 'variable_name']:
