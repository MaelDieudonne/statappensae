...
L'installation du package pyarrow, nécessaire pour manipuler les fichiers Parquet, est capricieuse. Il n'est pas toujours reconnu, entraînant une erreur d'importation dans Python. On commence donc par l'installer et vérifier qu'il est correctement chargé.
...
En cas d'échec, se reporter au notebook python_utils pour explorer des options d'installation alternatives.
