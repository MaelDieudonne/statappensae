...
```{r}
# On adapate les outcomes devant l'absence de candidat de gauche au second tour.
...
variables_of_interest <- c(mca_regressors, "prop014", "propnodip", "pouvr", mca_relative_outcomes)
