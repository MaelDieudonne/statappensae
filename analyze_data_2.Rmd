...
```{r}
regressors <- c("ppropri", "popcomm", "popagglo", "pinscript", "age", "prop014", "prop1539", "prop4059", "prop60p", "propf", "propnodip", "propbac", "propsup", "pagri", "pindp", "pcadr", "ppint", "pempl", "pouvr", "pchom", "petranger", "revmoy", "pcrimesdelits", "mmoyfortune", "pisf", "prsa", "type_comm")
relative_outcomes <- c("part_T1", "part_T2", "GD_ratio_T1", "EC_ratio_T1", "EC_ratio_T2")

variables_of_interest <- c(regressors, relative_outcomes)
