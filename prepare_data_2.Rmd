...
Plutôt que de les ajouter aux bases précédentes, ce qui les alourdirait considérablement, on créé une fonction permettant de générer dynamiquement la base nécessaire.
