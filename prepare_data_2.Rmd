...
for (year in unique(candidats$Annee)) {
  var_name_1 <- paste0("pop", year) 
  var_name_2 <- paste0("propnodip", year) 
  var_name_3 <- paste0("propbac", year) 
  var_name_4 <- paste0("propsup", year) 
  var_name_5 <- paste0("nodip", year) 
  var_name_6 <- paste0("bac", year)
  var_name_7 <- paste0("sup", year)
