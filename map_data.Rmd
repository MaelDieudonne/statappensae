...
title <- paste0("Participation aux élections présidentielles\nPremier tour, 1981\n", reg_name)
output_file <- paste0("output/part_1981_", reg_abrv, ".png")
...
plot <- ggplot() +
  ...
  scale_fill_viridis_c(name = "Participation", labels = scales::percent_format(scale = 100)) +
  ggtitle(paste(title)) +
  theme_minimal() +
...
rm(bbox, aspect_ratio, base_height, base_width, font_size, reg_abrv, reg_name, selected_reg, subset_map_data, title)
```
